...
if not exist "%~dp0exceladdin.xlam" (
  echo Missing exceladdin.xlam next to setup.cmd
  pause
  exit /b 1
)
...
$Host.UI.RawUI.WindowTitle = 'exceladdin setup'
# ========================================
...
# ===== CONFIG =====
$TargetDir      = 'C:\Apps'
$FilesToInstall = @('exceladdin.xlam','exceladdin.exportedui')
$AddInFile      = 'exceladdin.xlam'
