<#
 ...
 - Deploys exceladdin.xlam to C:\Apps
...
$xlamSrc = Join-Path $srcDir 'exceladdin.xlam'
if (!(Test-Path $xlamSrc)) { throw "Missing exceladdin.xlam in $srcDir" }

$appsDir  = 'C:\Apps'
$appsXlam = Join-Path $appsDir 'exceladdin.xlam'
